            ...
            "patterns": [
                {
                    ...
                    "match": "\\b(дія|як|ціль|мета|синонім|видалити|стала|змінна|композиція|секція|властивість|спец|я|розширити|зовнішня|внутрішня|місцева|покласти|відкласти|варіація|структура|перебрати|якщо|чекати|взяти|вернути|інакше|біб|поки)\\b"
                }
            ]
        },
        "strings": {
            ...
            "patterns": [
                {
                    ...
                    "match": "\\b(текст|памʼять|адреса|комірка|д64|логічне|ц8|ц16|ц32|ц64|ціле|д32|десяткове|п8|п16|ю8|п32|п64|позитивне|список|щось|ніщо|так|ні|пусто)\\b"
                }
            ]
        },
        "variables": {
