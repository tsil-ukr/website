            ...
            "patterns": [
                {
                    ...
                    "match": "\\b(дія|як|ціль|мета|і|або|синонім|видалити|стала|змінна|композиція|секція|властивість|спец|я|розширити|зовнішня|внутрішня|місцева|покласти|відкласти|варіація|структура|перебрати|якщо|чекати|взяти|вернути|інакше|біб|поки)\\b"
                }
            ]
        },
        "strings": {
            ...
            "patterns": [
                {
                    ...
                    "match": "\\b(текст|памʼять|адреса|невідома_памʼять|невідома_адреса|д64|т8|логічне|ц8|ц16|ц32|ц64|ціле|д32|р32|р64|ю8|п8|п16|п32|п64|позитивне|н8|н16|н32|н64|натуральне|список|щось|ніщо|так|ні|пусто)\\b"
                }
            ]
        },
        "variables": {
