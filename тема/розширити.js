            ...
            "patterns": [
                {
                    ...
                    "match": "\\b(дія|як|ціль|мета|і|або|вабо|синонім|видалити|стала|змінна|композиція|секція|властивість|спец|я|розширити|зовнішня|внутрішня|місцева|покласти|відкласти|варіація|структура|перебрати|якщо|чекати|взяти|вернути|інакше|біб|поки)\\b"
                }
            ]
        },
        "strings": {
            ...
            "patterns": [
                {
                    ...
                    "match": "\\b(текст|памʼять|адреса|невідома_памʼять|невідома_адреса|д64|т8|логічне|ц8|ц16|ц32|ц64|ціле|д32|д64|ю8|п8|п16|п32|п64|позитивне|п8|п16|п32|п64|природне|список|щось|ніщо|так|ні|пусто)\\b"
                }
            ]
        },
        "variables": {
